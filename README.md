...
Those actions select the code inside a method or property, so you can start typing faster. Of course, you can bind those actions to your favorite shortcuts to get maximum efficiency.
